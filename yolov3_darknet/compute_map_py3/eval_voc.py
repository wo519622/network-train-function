...
# Modify by Jeff 2019-12-20
# A function to calculate darknet yolov3 mAP
# --------------------------------------------------------
...
def parse_args():
    ...
    parser.add_argument('--result', dest='result', help='The darknet vaild result path', type=str)
    parser.add_argument('--data', dest='data', help='The train VOCdata path', type=str)
...
if __name__ == '__main__':
    args = parse_args()
    _do_python_eval(args.result, args.data, output_dir='output')
